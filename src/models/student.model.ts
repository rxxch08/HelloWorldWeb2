...
export async function update(id: number, student: StudentInput): Promise<Student | null> {
  const result = await pool.query<Student>(
...
export async function partialUpdate(id: number, data: Partial<StudentInput>): Promise<Student | null> {
